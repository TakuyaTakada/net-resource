...
func (l *DeviceLoader) Load(key ID) (*Device, error) {
...
func (l *DeviceLoader) LoadThunk(key ID) func() (*Device, error) {
	l.mu.Lock()
...
func (l *DeviceLoader) LoadAll(keys []ID) ([]*Device, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *DeviceLoader) LoadAllThunk(keys []ID) func() ([]*Device, []error) {
	results := make([]func() (*Device, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *DeviceLoader) Prime(key ID, value *Device) bool {
	l.mu.Lock()
	var found bool
...
func (l *DeviceLoader) Clear(key ID) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}

func (l *DeviceLoader) unsafeSet(key ID, value *Device) {
	if l.cache == nil {
...
func (b *deviceLoaderBatch) keyIndex(l *DeviceLoader, key ID) int {
